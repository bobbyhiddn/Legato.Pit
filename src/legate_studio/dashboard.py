...
# Repository names
REPOS = {"conduct": "Legato.Conduct", "library": "Legate.Library", "listen": "Legato.Listen"}
...
def get_system_status():
    ...
    for _key, repo_name in REPOS.items():
        try:
        ...
        statuses.append({"name": repo_name, "status": status, "text": text})
...
def get_stats():
    ...
    stats = {"motifs": 0, "notes": 0, "chords": 0}
...
def graph3d():
    ...
    return render_template("dashboard_graph3d.html", title="3D Knowledge Graph", stats=get_stats())
