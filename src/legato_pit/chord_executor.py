...
class ChordExecutor:
    ...
    def _create_repo(self, name: str, description: str) -> tuple[str, int]:
        ...
        payload = {
            "name": name,
            "description": f"Legato project: {description}",
            "private": False,
...
This project was spawned from a Legato knowledge entry.
...
def ensure_library_exists(token: str, org: str) -> dict:
    """
    Ensure a Legato.Library repository exists for the user.
    ...
    payload = {
        "name": "Legato.Library",
        "description": "Legato Knowledge Store - Personal knowledge artifacts",
        "private": False,
        "auto_init": False,
    }
    ...
    readme_content = f"""# Legato.Library

> Personal Knowledge Store - Managed by [Legato](https://github.com/{org}/Legato.Pit)

This repository stores your knowledge artifacts created through Legato.
...
This repository is managed by Legato. Knowledge artifacts are created automatically
when you interact with Claude through the Legato MCP tools.
...
"""
    ...
    requests.put(
        ...
        headers=headers,
        json={
            "message": "Initialize Legato.Library",
